...
import { getAnnouncementsForAngels } from './query/getAnnouncements';
...
export default class AngelEventsLoadingStrategy implements IEventsLoadingStrategy {
    public async execute(): Promise<Array<FeedItem>> {
        // Angels are interested in announcements targeting angels and all users
        const announcements: AnnouncementRow[] = await getAnnouncementsForAngels();
        ...
        // Angels are interested in new founder projects
        ...
        // Angels are interested in connecting to angels and other founders
